...
Система родительского контроля. В проекте есть Android-приложение родителя, Android-приложение ребенка, backend на Java/Spring Boot, база PostgreSQL, сервис для детекции и размытия нежелательного контента, AI-поддержка ребенка.
...
| Детектор нежелательного контента | Python, FastAPI, NudeNet-related detector flow |
| AI-ассистент и поддержка ребенка | Ollama, модель gemma2:2b|
...
| `blur` | Модуль детекции и сокрытия нежелательного контента |
...
## Тестирование
![](HnVideoEditor_2026_02_15_135657549.gif)
